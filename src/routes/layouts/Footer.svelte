...
<footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
      <div class="col-span-full hidden lg:col-span-1 lg:block">
        <a class="flex-none text-xl font-semibold" href="/" aria-label="Brand">UNIRA</a>
      </div>
      <!-- End Col -->
    ...
    <div class="pt-5 mt-5 border-t border-gray-200">
      <div class="sm:flex sm:justify-between sm:items-center">
        <div class="flex items-center gap-x-3 divide-solid">
          <p class=" text-xs sm:text-sm text-gray-600">Copyright © 2024 Universitas Madura - Dimas Farid</p>
        </div>
